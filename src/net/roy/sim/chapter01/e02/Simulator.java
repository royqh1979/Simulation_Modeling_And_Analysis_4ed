package net.roy.sim.chapter01.e02;
...
public class Simulator {
    ...
    public Simulator(double meanInterarrival, double meanService, double endTime) {
        ...
        serverStatus= net.roy.sim.chapter01.e02.ServerStatus.Idle;
        customerServed=0;
        ...
        nextEventTimes.put(EventType.CustomerDepart,
                Double.MAX_VALUE);
        nextEventTimes.put(EventType.SimulationEnd,
                endTime);
    }
    ...
    public void simulate(){
        while (true) {
            ...
            if (nextEvent == EventType.SimulationEnd) {
                break;
            }
        }
    }
