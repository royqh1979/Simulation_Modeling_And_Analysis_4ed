...
/**
 * Helper class for computing summary statistics of samples of a discrete time series variable,
 ...
 */
public class DiscreteTimeSeriesSummary {
    private long count;
    private long sum;
    private long max;
    private long min;
     ...
     */
    public DiscreteTimeSeriesSummary(String name,double time) {
        this.name=name;
        this.startTime=time;
        reset();
    }
     ...
     */
    public void addValue(long value,double time) {
